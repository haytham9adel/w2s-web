                     ...
                     <label class="col-sm-3 control-label">Privileges :</label>
                       <div class="col-sm-9">
                        ...
                        <div class="radio">
                             ...
                             <label>
	                            <input type="radio" name="permission"  value="1"  id="permission"> Main School Admin
             ...
             <c:set var="count" value="1" scope="page" />
              ...
              <div class="info-block"> 
               ...
               <div class="col-b" style="text-align:right;">
               		<a href="school/editSchoolAdmin?user_id=${school_admin.user_id}"><i class="fa fa-pencil-square-o fa-2x edit"></i></a>
               </div>
               <% } %>
               </div>
                 <div class="info-group">
