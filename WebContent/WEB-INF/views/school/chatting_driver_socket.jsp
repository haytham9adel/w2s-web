...
$(document).ready(function(){
	getMessage("${school_admins[0].driver_id}");
		...
		<div class="row">
			...
			<div class="conversation-wrap col-sm-3" id="user-list">
				...
				<c:forEach items="${school_admins}" var="school_admin">
					<div class="media conversation" id="left_user_${school_admin.driver_id}">
						...
						<div class="media-body">
							<h5 class="media-heading clearfix">
								...
								<a class="pull-left scrDown" href="javascript:void(0);"
									...
									id="${school_admin.driver_id}">
									${fn:toUpperCase(school_admin.driver_fname)}
									${fn:toUpperCase(school_admin.driver_lname)}
								<c:if	test="${school_admin.status > 0}">
								<small class="notify" id="notify-${school_admin.driver_id}">${school_admin.status}</small>
								</c:if>
								</a>
							</h5>
						</div>
