...
<div class="section top_bread clearfix">
   	<div class="container">
		<div class="row">
			<div class="col-md-12">
               	<p class="align-right"><span class="">الصفحة الرئيسية</span>/<span  class="yellow">الخصائص</span></p>
               </div>
   		</div>
       </div>
   </div>
   ...
   <div class="section clearfix">
   	<div class="container bg-body pad0">
		<ul class="nav nav-tabs featured-ul">
  		    <li class="ftrd-tab active"><a class="featured-active" data-toggle="tab" href="#home">الكل</a></li>
   			<li class="ftrd-tab"><a data-toggle="tab" href="#menu1">الآباء</a></li>
   			<li class="ftrd-tab"><a data-toggle="tab" href="#menu2">المدرسة</a></li>
   			<li class="ftrd-tab"><a data-toggle="tab" href="#menu3">الطلاب</a></li>
 			</ul>
            ...
            <div class="col-md-3 col-sm-6 bshad">
                <div class="content-box box-default">
					<c:choose>
               	  ...
               	  <p class="box-head top-margin">${features.title_ar}</p>
                    <p>${features.content_ar}</p>
                </div>
            </div>
   </c:forEach>         
    </div>
