    ...
    selected="selected"
              ...
              <%--      <div class="form-group">
				...
				<div class="col-sm-12">
					...
					<button class="add_field_button btn btn-submit" style="float:right;"><i class="fa fa-plus " aria-hidden="true"></i></button>
                      ...
                      <div class="form-group">
                       <div class="col-sm-9">
                        <input  class="btn btn-primary btn-submit" id="save" value="Save" type="submit">&nbsp;&nbsp;
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
              <div class="info-block"> 
                ...
                <div class="col-md-12"> 
                <form action="admin/sendDriverPassword" method="post">
  ...
  $(document).ready(function(){
		...
		$('#cancel').on('click', function(e) {
			...
			swal({
				...
				if (isConfirm)
					window.location = "admin/manageDrivers";
			});
		})	 
  });
...
<script>
	/* $(document).ready(function(){
        ...
        reader.onload = function (e) {
            ...
            $('#image_path').val('src',e.target.result);
        };
