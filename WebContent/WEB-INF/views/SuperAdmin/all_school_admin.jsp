...
<div class="col-md-9 col-sm-9 col-xs-12 pad0">
	...
	<a href="admin/addSchoolAdmin/" class="btn btn-primary btn-submit" style="float:right; margin:12px ">Add New</a>
	<% } %>
	...
	<table id="example" class="mdl-data-table" cellspacing="0" width="100%">
    	...
    	<td style="min-width:113px !important;">
    	...
    	<%-- <a title="View" href="admin/viewSchoolAdmin?q=<%=new String(encodedBytes)%>"><i class="fa fa-eye fa-2x edit"></i>	</a>
    	<% if((Integer)session.getAttribute("permission")==1) {%>
    	<a title="Edit" href="admin/editSchoolAdmin?q=<%=new String(encodedBytes)%>"><i class="fa fa-pencil-square-o fa-2x edit"></i></a>
...
<% } %> --%>
		<div class="btn-group">
	          <a title="View" class="btn btn-danger"  href="admin/viewSchoolAdmin?q=<%=new String(encodedBytes)%>"><i class="fa fa-eye edit"></i>	</a>
		    	<% if((Integer)session.getAttribute("permission")==1) {%>
		    	<a title="Edit" class="btn btn-danger"  href="admin/editSchoolAdmin?q=<%=new String(encodedBytes)%>"><i class="fa fa-pencil-square-o edit"></i></a>
...
function confirmBox(id)
{
	swal({
		...
		if (isConfirm)
			window.location="admin/deleteSchoolAdmin?user_id="+id;
	});
}
