...
public class JSONUtils {
	...
	/**
	 * JSON when message needs to be sent to specific the clients
	 * */
	public String getSendAllMessageJsonSpecific(String sessionId, String fromName,
			String message,String user_id,String sender_name,String chat_type) {
		String json = null;
		...
		try {
			...
			jObj.put("sender_name", sender_name);
			jObj.put("chat_type", chat_type);
